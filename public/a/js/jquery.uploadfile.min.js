 ...
 * http://hayageek.com/
 *
 * Edited & tailored to own needs by Smartheads
 * http://smartheads.pl
 */
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
	   ...
	   this.startUpload = function () {
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.preview = $("<img class='ajax-file-upload-preview' />").css({'max-width': s.previewWidth, 'max-height': s.previewHeight}).appendTo(this.statusbar).hide();
