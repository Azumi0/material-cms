CoolClock.config.skins = {
	...
	customSkin: {
		outerBorder:      { lineWidth: 2, radius: 90, color: "#868686", alpha: 1 },
		smallIndicator:   { lineWidth: 1, startAt: 85, endAt: 90, color: "#868686", alpha: 1 },
		largeIndicator:   { lineWidth: 2, startAt: 80, endAt: 90, color: "#868686", alpha: 1 },
		hourHand:         { lineWidth: 2, startAt: 0, endAt: 50, color: "#313A42", alpha: 1 },
		minuteHand:       { lineWidth: 3, startAt: 0, endAt: 80, color: "#D1C130", alpha: 1 },
		secondHand:       { lineWidth: 1, startAt: 0, endAt: 65, color: "#313A42", alpha: 1 },
		secondDecoration: { lineWidth: 2, startAt: 88, radius: 2, fillColor: "#313A42", color: "#313A42", alpha: 1 }
	},
	swissRail: {
